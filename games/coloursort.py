...
def gameloop():
    ...
    bg = pygame.image.load('image/car.jpg')

    
    # setting our player
    maincar = pygame.image.load('image\rr.jpg')
    maincarX = 350
    maincarY = 495
    maincarX_change = 0
    maincarY_change = 0
    ...
    #other cars
    car1 = pygame.image.load('image\dd.jpg')
    car1X = random.randint(178,490)
    car1Y = 100

    car2 = pygame.image.load('image\tt.jpg')
    car2X = random.randint(178,490)
    car2Y = 100

    car3 = pygame.image.load('image\yh.jpg')
